...
# resize_vocab (below) randomly initializes new embedding/LM-head rows --
# must seed before that happens, not just before training, for those
# rows to be reproducible too.
set_seed(SEED)
...
train_examples, val_examples = split_documents(example_id_lists, val_split_ratio=0.15, seed=SEED)
